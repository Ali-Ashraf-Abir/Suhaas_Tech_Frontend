...
const RegisterPage: React.FC = () => {
    ...
    const validateForm = (): boolean => {
        ...
        if (!formData.token) {
            errors.token = 'Invalid or missing invite token';
        }
                        ...
                        <div className="space-y-1">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-11 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all ${validationErrors.name
                        ...
                        <div className="space-y-1">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={`w-full pl-11 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all ${validationErrors.token
                                        ? 'border-red-300 focus:ring-red-500'
                                        : 'border-gray-300 focus:ring-indigo-500'
                                        }`}
                                />
                        ...
                        <div className="space-y-1">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={`w-full pl-11 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all ${validationErrors.password
                                        ? 'border-red-300 focus:ring-red-500'
                                        : 'border-gray-300 focus:ring-indigo-500'
                                        }`}
                                />
                        ...
                        <div className="space-y-1">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={`w-full pl-11 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all ${validationErrors.confirmPassword
                                        ? 'border-red-300 focus:ring-red-500'
                                        : 'border-gray-300 focus:ring-indigo-500'
                                        }`}
                                />
